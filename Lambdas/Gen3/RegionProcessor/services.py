...
from utils import tag_cyngular_bucket, check_access_entry_exists, create_cyngular_access_entry
...
def process_dns_service(
    ...
    try:
        ...
        bucket_to_tag = (
            cyngular_bucket if enable_param.lower() == "true" else enable_param
        )

        # Tag the appropriate bucket for DNS logging
        tagging_result = tag_cyngular_bucket(
            bucket_to_tag, {"cyngular-dnslogs": "true"}
        )
...
def process_vfl_service(
    ...
    try:
        ...
        tagging_result = tag_cyngular_bucket(
            bucket_to_tag, {"cyngular-vpcflowlogs": "true"}
        )
...
def process_eks_service(
    region: str, cyngular_role_arn: str, enable_param: str, cyngular_bucket: str
) -> Dict[str, Any]:
    ...
    try:
        ...
        tagging_result = tag_cyngular_bucket(
            cyngular_bucket, {"cyngular-ekslogs": "true"}
        )
